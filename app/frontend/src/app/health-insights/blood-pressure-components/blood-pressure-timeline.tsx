...
export function BloodPressureTimeline({ data, timeframe = 7 }: { data: BloodPressureDataPoint[]; timeframe?: number }) {
  ...
  const stages = ["Optimal", "Normal", "High - Normal", "Grade 1 (mild) Hypertension", "Grade 2 (moderate) Hypertension",  "Grade 3 (severe) Hypertension"];
  const color = {
    "Optimal": "#4ade80",
    "Normal": "#bef264",
    "High - Normal": "#fde047",
    "Grade 1 (mild) Hypertension": "#fde047",
    "Grade 2 (moderate) Hypertension": "#fb923c",
    "Grade 3 (severe) Hypertension": "#ef4444",
  };
  ...
  return (
    <div className="w-full max-w-2xl flex flex-col items-center">
      <h3 className="text-lg font-semibold mb-4 text-center text-slate-700">
        Blood Pressure Timeline ({timeframe <= 1 ? `${24 * timeframe}h` : `${timeframe}d`})
      </h3>
      <svg
      ...
      >
        <title>Blood Pressure Timeline showing stages over time</title>
